...
$route['estatistica/(:num)'] = 'categorias/chart/$1';
$route['postagem/(:num)/(:any)'] = 'postagens/index/$1/$2';
$route['ocorrencia/(:num)'] = 'ocorrencia/index/$1';
$route['autor/(:num)/(:any)'] = 'sobrenos/autores/$1/$2';
$route['admin/login'] = 'admin/usuarios/pag_login';
$route['conta/login'] = 'conta/usuario/pag_login';
$route['conta/cadastro'] = 'conta/usuario/pag_cad';