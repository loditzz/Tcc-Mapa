        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="login-panel panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    echo form_open('conta/usuario/login');
                    ?>
                    <fieldset>
                        <div class="form-group">
                            <input class="form-control" placeholder="Email" name="txt-user" type="text" autofocus>
                        </div>
                        <div class="form-group">
            ...
            <a href="<?php echo base_url('conta/cadastro') ?>">Cadastrar</a>
        </div>
    </div>
</div>